...
ax.grid()
ax.set_title('m) Cold extreme and wind direction, RCP8.5 ($F_H$ = 0.18 Sv)')
...
ax.grid()
ax.set_title('m) Warm extreme and wind direction, RCP8.5 ($F_H$ = 0.18 Sv)')
...
ax.set_title('n) Cold extreme return times, RCP8.5 ($F_H$ = 0.18 Sv)')
...
ax.set_title('n) Warm extreme return times, RCP8.5 ($F_H$ = 0.18 Sv)')
...
ax.set_title('h) Daily average, RCP8.5 ($F_H$ = 0.18 Sv)')
...
ax.set_title('o) Daily minima, RCP8.5 ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
...
ax.set_title('p) Daily maxima, RCP8.5 ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
