...
ax.set_title('n) Zonal velocity, RCP8.5 ($F_H = 0.18$ Sv)')
...
fig.suptitle('m) Potential temperature, RCP8.5 ($F_H = 0.18$ Sv)')
...
fig.suptitle('n) Thermal wind balance, RCP8.5 ($F_H = 0.18$ Sv)')
