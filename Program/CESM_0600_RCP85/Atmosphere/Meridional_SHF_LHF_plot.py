...
ax.set_title('m) MHT (January), RCP8.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('n) Eddy MHT (January), RCP8.5 ($F_H = 0.18$ Sv)')
...
fig.suptitle('n) Eddy MHT, RCP8.5 ($F_H = 0.18$ Sv)', fontsize = 13)
...
ax.set_title('m) MHT$_{\mathrm{S}}$ (January), RCP8.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('n) MHT$_{\mathrm{S,eddy}}$ (January), RCP8.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('MHT by LHF (January), RCP8.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('Eddy MHT by LHF (January), RCP8.5 ($F_H = 0.18$ Sv)')
