...
ax.set_title('k) MHT (January), RCP4.5 ($F_H = 0.45$ Sv)')
...
ax.set_title('l) Eddy MHT (January), RCP4.5 ($F_H = 0.45$ Sv)')
...
fig.suptitle('l) Eddy MHT, RCP4.5 ($F_H = 0.45$ Sv)', fontsize = 13)
...
ax.set_title('k) MHT$_{\mathrm{S}}$ (January), RCP4.5 ($F_H = 0.45$ Sv)')
...
ax.set_title('l) MHT$_{\mathrm{S,eddy}}$ (January), RCP4.5 ($F_H = 0.45$ Sv)')
...
ax.set_title('MHT by LHF (January), RCP4.5 ($F_H = 0.45$ Sv)')
...
ax.set_title('Eddy MHT by LHF (January), RCP4.5 ($F_H = 0.45$ Sv)')
