...
fh = netcdf.Dataset(directory_1500_RCP+'Atmosphere/Climatology_De_Bilt.nc', 'r')
...
ax.grid()
ax.set_title('k) Cold extreme and wind direction, RCP4.5 ($F_H$ = 0.45 Sv)')

#-----------------------------------------------------------------------------------------

ax2 	= fig.add_axes([0.69, 0.43, 0.28, 0.40])
...
ax.grid()
ax.set_title('k) Warm extreme and wind direction, RCP4.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('l) Cold extreme return times, RCP4.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('l) Warm extreme return times, RCP4.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('g) Daily average, RCP4.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('m) Daily minima, RCP4.5 ($F_H$ = 0.45 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
...
ax.set_title('n) Daily maxima, RCP4.5 ($F_H$ = 0.45 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
