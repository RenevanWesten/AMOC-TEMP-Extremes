...
fh = netcdf.Dataset(directory_0600_RCP+'Atmosphere/TEMP_2m_Europe_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
lon_global, lat_global, return_level_min	= ReadinDataGEV(directory_0600_RCP+'/Atmosphere/TEMP_2m_extremes_GEV_fit_minima.nc', return_period)
...
ax.set_title('e) January temperature and 1:10-year cold extreme, RCP4.5 ($F_H = 0.18$ Sv)', fontsize = 11)
