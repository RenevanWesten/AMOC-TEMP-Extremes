...
fh 		    = netcdf.Dataset(directory_0600_RCP+'Atmosphere/UVEL_TEMP_Atlantic_sector_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('j) Zonal velocity, RCP4.5 ($F_H = 0.18$ Sv)')
...
fig.suptitle('i) Potential temperature, RCP4.5 ($F_H = 0.18$ Sv)')
...
fig.suptitle('j) Thermal wind balance, RCP4.5 ($F_H = 0.18$ Sv)')
