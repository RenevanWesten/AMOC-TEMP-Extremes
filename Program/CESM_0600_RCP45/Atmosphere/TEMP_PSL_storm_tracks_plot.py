...
fh = netcdf.Dataset(directory_0600_RCP+'Atmosphere/TEMP_PSL_storm_tracks_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
fh = netcdf.Dataset(directory_0600_PI+'Atmosphere/TEMP_PSL_storm_tracks_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('i) Sea-level pressure and temperature variance, RCP4.5 ($F_H = 0.18$ Sv)', fontsize = 9)
