...
fh = netcdf.Dataset(directory_0600_RCP+'Atmosphere/Meridional_SHF_LHF_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('i) MHT (January), RCP4.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('j) Eddy MHT (January), RCP4.5 ($F_H = 0.18$ Sv)')
...
fig.suptitle('j) Eddy MHT, RCP4.5 ($F_H = 0.18$ Sv)', fontsize = 13)

#-----------------------------------------------------------------------------------------	
#-----------------------------------------------------------------------------------------	
#-----------------------------------------------------------------------------------------	
	
fh = netcdf.Dataset(directory_0600_RCP+'Atmosphere/SHF_LHF_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('i) MHT$_{\mathrm{S}}$ (January), RCP4.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('j) MHT$_{\mathrm{S,eddy}}$ (January), RCP4.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('MHT by LHF (January), RCP4.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('Eddy MHT by LHF (January), RCP4.5 ($F_H = 0.18$ Sv)')
