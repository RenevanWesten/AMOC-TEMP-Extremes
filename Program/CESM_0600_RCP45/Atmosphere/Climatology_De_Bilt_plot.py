...
directory_0600_RCP	= '../../../Data/CESM_0600_RCP45/'
...
fh = netcdf.Dataset(directory_0600_RCP+'Atmosphere/Climatology_De_Bilt.nc', 'r')
...
ax.grid()
ax.set_title('i) Cold extreme and wind direction, RCP4.5 ($F_H$ = 0.18 Sv)')
...
ax.grid()
ax.set_title('i) Warm extreme and wind direction, RCP4.5 ($F_H$ = 0.18 Sv)')
...
ax.set_title('j) Cold extreme return times, RCP4.5 ($F_H$ = 0.18 Sv)')
...
ax.set_title('j) Warm extreme return times, RCP4.5 ($F_H$ = 0.18 Sv)')

#-----------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------

fh = netcdf.Dataset(directory_0600_PI+'Atmosphere/Climatology_De_Bilt.nc', 'r')

#Writing data to correct variable			
temp_all_0600		= fh.variables['TEMP'][:] 			
temp_all_min_0600	= fh.variables['TEMP_min'][:] 			
temp_all_max_0600	= fh.variables['TEMP_max'][:] 			

fh.close()

#-----------------------------------------------------------------------------------------

ice_days_ref		= round(len(np.where(temp_all_max_0600 < 0.0)[0]) / len(temp_all_0600), 1)
frost_days_ref 		= round(len(np.where(temp_all_min_0600 < 0.0)[0]) / len(temp_all_0600), 1)
warm_days_ref 		= round(len(np.where(temp_all_max_0600 >= 20.0)[0]) / len(temp_all_0600), 1)
summer_days_ref 	= round(len(np.where(temp_all_max_0600 >= 25.0)[0]) / len(temp_all_0600), 1)
tropical_days_ref	= round(len(np.where(temp_all_max_0600 >= 30.0)[0]) / len(temp_all_0600), 1)
tropical_nights_ref	= round(len(np.where(temp_all_min_0600 >= 20.0)[0]) / len(temp_all_0600), 1)
...
ax.fill_between(day_cesm, np.min(temp_all_0600, axis = 0), np.max(temp_all_0600, axis = 0), alpha=0.25, edgecolor='orange', facecolor='orange')
ax.plot(day_cesm, np.mean(temp_all_0600, axis = 0), '-', color = 'orange', label = 'AMOC on')
...
ax.set_title('f) Daily average, RCP4.5 ($F_H$ = 0.18 Sv)')
...
ax.fill_between(day_cesm, np.min(temp_all_min_0600, axis = 0), np.max(temp_all_min_0600, axis = 0), alpha=0.25, edgecolor='orange', facecolor='orange')
ax.plot(day_cesm, np.mean(temp_all_min_0600, axis = 0), '-', color = 'orange', label = 'AMOC on')
...
ax.set_title('k) Daily minima, RCP4.5 ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
...
ax.fill_between(day_cesm, np.min(temp_all_max_0600, axis = 0), np.max(temp_all_max_0600, axis = 0), alpha=0.25, edgecolor='orange', facecolor='orange')
ax.plot(day_cesm, np.mean(temp_all_max_0600, axis = 0), '-', color = 'orange', label = 'AMOC on')
...
ax.set_title('l) Daily maxima, RCP4.5 ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
