...
lon, lat, return_level_min_RCP	= ReadinDataGEV(directory_0600_RCP+'/Atmosphere/TEMP_2m_extremes_GEV_fit_minima.nc', return_period)
lon, lat, return_level_max_RCP	= ReadinDataGEV(directory_0600_RCP+'/Atmosphere/TEMP_2m_extremes_GEV_fit_maxima.nc', return_period)
...
return_level_min_plot					= return_level_min_RCP - return_level_min_0600
...
return_level_max_plot					= return_level_max_RCP - return_level_max_0600
...
ax.set_title('i) 1:10-year cold extreme, RCP4.5 ($F_H = 0.18$ Sv)')
...
ax.set_title('j) 1:10-year warm extreme, RCP4.5 ($F_H = 0.18$ Sv)')
