...
fh = netcdf.Dataset(directory_1500_RCP+'Atmosphere/Jet_200_hPa_Atlantic_sector_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('o) 200 hPa velocities, RCP8.5 ($F_H = 0.45$ Sv)')
