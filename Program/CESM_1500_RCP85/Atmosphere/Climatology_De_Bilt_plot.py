...
ax.grid()
ax.set_title('o) Cold extreme and wind direction, RCP8.5 ($F_H$ = 0.45 Sv)')
...
ax.grid()
ax.set_title('o) Warm extreme and wind direction, RCP8.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('p) Cold extreme return times, RCP8.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('p) Warm extreme return times, RCP8.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('i) Daily average, RCP8.5 ($F_H$ = 0.45 Sv)')
...
ax.set_title('q) Daily minima, RCP8.5 ($F_H$ = 0.45 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
...
ax.set_title('r) Daily maxima, RCP8.5 ($F_H$ = 0.45 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
