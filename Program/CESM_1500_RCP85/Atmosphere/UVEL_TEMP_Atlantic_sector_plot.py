...
ax.set_title('p) Zonal velocity, RCP8.5 ($F_H = 0.45$ Sv)')
...
fig.suptitle('o) Potential temperature, RCP8.5 ($F_H = 0.45$ Sv)')
...
fig.suptitle('p) Thermal wind balance, RCP8.5 ($F_H = 0.45$ Sv)')
