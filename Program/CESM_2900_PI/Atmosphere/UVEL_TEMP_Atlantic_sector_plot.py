...
fh 		    = netcdf.Dataset(directory_2900_PI+'Atmosphere/UVEL_TEMP_Atlantic_sector_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('h) Zonal velocity, AMOC off ($F_H = 0.45$ Sv)')
...
fig.suptitle('g) Potential temperature, AMOC off ($F_H = 0.45$ Sv)')
...
fig.suptitle('h) Thermal wind balance, AMOC off ($F_H = 0.45$ Sv)')
