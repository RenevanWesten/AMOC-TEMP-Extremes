...
fh = netcdf.Dataset(directory_2900_PI+'Atmosphere/Jet_200_hPa_Atlantic_sector_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('g) 200 hPa velocities, AMOC off ($F_H = 0.45$ Sv)')
