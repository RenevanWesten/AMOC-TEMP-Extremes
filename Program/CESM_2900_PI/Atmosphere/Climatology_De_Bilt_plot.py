...
directory_2900_PI	= '../../../Data/CESM_2900_PI/'
...
fh = netcdf.Dataset(directory_2900_PI+'Atmosphere/Climatology_De_Bilt.nc', 'r')
...
ax.grid()
ax.set_title('g) Cold extreme and wind direction, AMOC off ($F_H$ = 0.45 Sv)')
...
ax.grid()
ax.set_title('g) Warm extreme and direction, AMOC off ($F_H$ = 0.45 Sv)')
...
ax.set_title('h) Cold extreme return times, AMOC off ($F_H$ = 0.45 Sv)')
...
ax.set_title('h) Warm extreme return times, AMOC off ($F_H$ = 0.45 Sv)')
...
#Writing data to correct variable			
temp_all_1500		= fh.variables['TEMP'][:] 			
temp_all_min_1500	= fh.variables['TEMP_min'][:] 			
temp_all_max_1500	= fh.variables['TEMP_max'][:] 			

fh.close()

#-----------------------------------------------------------------------------------------

ice_days_ref		= round(len(np.where(temp_all_max_1500 < 0.0)[0]) / len(temp_all_1500), 1)
frost_days_ref 		= round(len(np.where(temp_all_min_1500 < 0.0)[0]) / len(temp_all_1500), 1)
warm_days_ref 		= round(len(np.where(temp_all_max_1500 >= 20.0)[0]) / len(temp_all_1500), 1)
summer_days_ref 	= round(len(np.where(temp_all_max_1500 >= 25.0)[0]) / len(temp_all_1500), 1)
tropical_days_ref	= round(len(np.where(temp_all_max_1500 >= 30.0)[0]) / len(temp_all_1500), 1)
tropical_nights_ref	= round(len(np.where(temp_all_min_1500 >= 20.0)[0]) / len(temp_all_1500), 1)
...
ax.fill_between(day_cesm, np.min(temp_all_1500, axis = 0), np.max(temp_all_1500, axis = 0), alpha=0.25, edgecolor='orange', facecolor='orange')
ax.plot(day_cesm, np.mean(temp_all_1500, axis = 0), '-', color = 'orange', label = 'AMOC on')
...
ax.set_title('e) Daily average, AMOC off ($F_H$ = 0.45 Sv)')
...
ax.fill_between(day_cesm, np.min(temp_all_min_1500, axis = 0), np.max(temp_all_min_1500, axis = 0), alpha=0.25, edgecolor='orange', facecolor='orange')
ax.plot(day_cesm, np.mean(temp_all_min_1500, axis = 0), '-', color = 'orange', label = 'AMOC on')
...
ax.set_title('i) Daily minima, AMOC off ($F_H$ = 0.45 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
...
ax.fill_between(day_cesm, np.min(temp_all_max_1500, axis = 0), np.max(temp_all_max_1500, axis = 0), alpha=0.25, edgecolor='orange', facecolor='orange')
ax.plot(day_cesm, np.mean(temp_all_max_1500, axis = 0), '-', color = 'orange', label = 'AMOC on')
...
ax.set_title('j) Daily maxima, AMOC off ($F_H$ = 0.45 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
