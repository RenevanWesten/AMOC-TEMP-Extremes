...
fh = netcdf.Dataset(directory_2900_PI+'Atmosphere/TEMP_PSL_storm_tracks_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('g) Sea-level pressure and temperature variance, AMOC off ($F_H = 0.45$ Sv)', fontsize = 9)
