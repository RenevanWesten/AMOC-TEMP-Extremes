...
fh = netcdf.Dataset(directory_2900_PI+'Atmosphere/Meridional_SHF_LHF_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('g) MHT (January), AMOC off ($F_H = 0.45$ Sv)')
...
ax.set_title('h) Eddy MHT (January), AMOC off ($F_H = 0.45$ Sv)')
...
fig.suptitle('h) Eddy MHT, AMOC off ($F_H = 0.45$ Sv)', fontsize = 13)

#-----------------------------------------------------------------------------------------	
#-----------------------------------------------------------------------------------------	
#-----------------------------------------------------------------------------------------	
	
fh = netcdf.Dataset(directory_2900_PI+'Atmosphere/SHF_LHF_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('g) MHT$_{\mathrm{S}}$ (January), AMOC off ($F_H = 0.45$ Sv)')
...
ax.set_title('h) MHT$_{\mathrm{S,eddy}}$ (January), AMOC off ($F_H = 0.45$ Sv)')
...
ax.set_title('MHT by LHF (January), AMOC off ($F_H = 0.45$ Sv)')
...
ax.set_title('Eddy MHT by LHF (January), AMOC off ($F_H = 0.45$ Sv)')
