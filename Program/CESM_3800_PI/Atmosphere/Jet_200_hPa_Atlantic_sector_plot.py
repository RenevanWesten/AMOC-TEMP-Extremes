...
fh = netcdf.Dataset(directory_3800_PI+'Atmosphere/Jet_200_hPa_Atlantic_sector_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('e) 200 hPa velocities, AMOC off ($F_H = 0.18$ Sv)')
