...
fh = netcdf.Dataset(directory_3800_PI+'Atmosphere/TEMP_PSL_storm_tracks_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('e) Sea-level pressure and temperature variance, AMOC off ($F_H = 0.18$ Sv)', fontsize = 9)
