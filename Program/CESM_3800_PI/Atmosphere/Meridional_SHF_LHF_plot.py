...
fh = netcdf.Dataset(directory_3800_PI+'Atmosphere/Meridional_SHF_LHF_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('e) MHT (January), AMOC off ($F_H = 0.18$ Sv)')
...
ax.set_title('f) Eddy MHT (January), AMOC off ($F_H = 0.18$ Sv)')
...
fig.suptitle('f) Eddy MHT, AMOC off ($F_H = 0.18$ Sv)', fontsize = 13)

#-----------------------------------------------------------------------------------------	
#-----------------------------------------------------------------------------------------	
#-----------------------------------------------------------------------------------------	
	
fh = netcdf.Dataset(directory_3800_PI+'Atmosphere/SHF_LHF_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('e) MHT$_{\mathrm{S}}$ (January), AMOC off ($F_H = 0.18$ Sv)')
...
ax.set_title('f) MHT$_{\mathrm{S,eddy}}$ (January), AMOC off ($F_H = 0.18$ Sv)')
...
ax.set_title('MHT by LHF (January), AMOC off ($F_H = 0.18$ Sv)')
...
ax.set_title('Eddy MHT by LHF (January), AMOC off ($F_H = 0.18$ Sv)')
