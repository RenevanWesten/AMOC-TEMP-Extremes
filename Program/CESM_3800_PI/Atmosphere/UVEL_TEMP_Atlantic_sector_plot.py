...
fh 		    = netcdf.Dataset(directory_3800_PI+'Atmosphere/UVEL_TEMP_Atlantic_sector_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('f) Zonal velocity, AMOC off ($F_H = 0.18$ Sv)')
...
fig.suptitle('e) Potential temperature, AMOC off ($F_H = 0.18$ Sv)')
...
fig.suptitle('f) Thermal wind balance, AMOC off ($F_H = 0.18$ Sv)')
