...
fh = netcdf.Dataset(directory_3800_PI+'Atmosphere/Climatology_De_Bilt.nc', 'r')
...
ax.grid()
ax.set_title('e) Cold extreme and wind direction, AMOC off ($F_H$ = 0.18 Sv)')
...
ax.grid()
ax.set_title('e) Warm extreme and direction, AMOC off ($F_H$ = 0.18 Sv)')
...
ax.set_title('f) Cold extreme return times, AMOC off ($F_H$ = 0.18 Sv)')
...
ax.set_title('f) Warm extreme return times, AMOC off ($F_H$ = 0.18 Sv)')
...
ax.set_title('d) Daily average, AMOC off ($F_H$ = 0.18 Sv)')
...
ax.set_title('g) Daily minima, AMOC off ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
...
ax.set_title('h) Daily maxima, AMOC off ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
