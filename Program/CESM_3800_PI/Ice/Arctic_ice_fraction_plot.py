...
fh 		= netcdf.Dataset(directory_3800_PI+'Ice/Arctic_ice_fraction_month_'+str(12)+'_year_'+str(year_start)+'-'+str(year_end)+'.nc', 'r')
...
fh 		= netcdf.Dataset(directory_3800_PI+'Ice/Arctic_ice_fraction_month_'+str(1)+'_year_'+str(year_start)+'-'+str(year_end)+'.nc', 'r')

fraction_jan	= np.mean(fh.variables['Fraction'][:], axis = 0)

fh.close()

fh 		= netcdf.Dataset(directory_3800_PI+'Ice/Arctic_ice_fraction_month_'+str(2)+'_year_'+str(year_start)+'-'+str(year_end)+'.nc', 'r')

fraction_feb	= np.mean(fh.variables['Fraction'][:], axis = 0)

fh.close()

fh 		= netcdf.Dataset(directory_3800_PI+'Ice/Arctic_ice_fraction_month_'+str(3)+'_year_'+str(year_start)+'-'+str(year_end)+'.nc', 'r')
...
ax.set_title('c) Arctic sea-ice extent, February, AMOC off ($F_H$ = 0.18 Sv)')
