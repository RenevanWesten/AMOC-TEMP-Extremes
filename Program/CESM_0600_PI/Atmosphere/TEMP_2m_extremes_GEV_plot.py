...
lon, lat, return_level_min	= ReadinDataGEV(directory_0600_PI+'/Atmosphere/TEMP_2m_extremes_GEV_fit_minima.nc', return_period)
lon, lat, return_level_max	= ReadinDataGEV(directory_0600_PI+'/Atmosphere/TEMP_2m_extremes_GEV_fit_maxima.nc', return_period)
...
ax.set_title('a) 1:10-year cold extreme, AMOC on ($F_H = 0.18$ Sv)')
...
ax.set_title('b) 1:10-year warm extreme, AMOC on ($F_H = 0.18$ Sv)')
