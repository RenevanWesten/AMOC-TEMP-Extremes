...
ax.grid()
ax.set_title('a) Cold extreme and wind direction, AMOC on ($F_H$ = 0.18 Sv)')
...
ax.grid()
ax.set_title('a) Warm extreme and direction, AMOC on ($F_H$ = 0.18 Sv)')
...
ax2 	= fig.add_axes([0.5224, 0.13, 0.35, 0.40], projection = ccrs.PlateCarree())

gl = ax2.gridlines(draw_labels=True)
gl.top_labels = False
gl.right_labels = False
ax2.set_extent([-17, 17, 38, 62], ccrs.PlateCarree())
ax2.coastlines('50m')
...
#De Bilt
ax2.scatter(5.18, 52.10, marker = 'D', color = 'firebrick' , s = 45, edgecolor = 'k', linewidth = 0.75, transform=ccrs.PlateCarree(), zorder = 10)
ax2.text(5.18+1.05, 52.10-0.20, 'De Bilt', color = 'firebrick', fontsize = 13, horizontalalignment='left', verticalalignment='center', transform=ccrs.PlateCarree(), zorder = 10)
ax2.set_title('De Bilt (5.18$^{\circ}$E, 52.1$^{\circ}$N)')

ax.set_title('b) Cold extreme return times, AMOC on ($F_H$ = 0.18 Sv)')
...
ax.set_title('b) Warm extreme return times, AMOC on ($F_H$ = 0.18 Sv)')
...
ax.set_title('b) Daily average, AMOC on ($F_H$ = 0.18 Sv)')
...
ax.set_title('c) Daily minima, AMOC on ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
...
ax.set_title('d) Daily maxima, AMOC on ($F_H$ = 0.18 Sv)')
legend_1	= ax.legend(loc=(0.265, 0.02), ncol=1, framealpha = 1.0, numpoints = 1)
