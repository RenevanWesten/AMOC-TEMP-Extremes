...
lon_global, lat_global, return_level_min	= ReadinDataGEV(directory_0600_PI+'/Atmosphere/TEMP_2m_extremes_GEV_fit_minima.nc', return_period)
...
ax.set_title('c) January temperature and 1:10-year cold extreme, AMOC on ($F_H = 0.18$ Sv)', fontsize = 11)
