...
ax.set_title('d) Zonal velocity, AMOC on ($F_H = 0.45$ Sv)')
...
fig.suptitle('c) Potential temperature, AMOC on ($F_H = 0.45$ Sv)')
...
fig.suptitle('d) Thermal wind balance, AMOC on ($F_H = 0.45$ Sv)')
