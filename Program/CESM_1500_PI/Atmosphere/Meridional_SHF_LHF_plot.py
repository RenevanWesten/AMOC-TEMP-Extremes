...
ax.set_title('c) MHT (January), AMOC on ($F_H = 0.45$ Sv)')
...
ax.set_title('d) Eddy MHT (January), AMOC on ($F_H = 0.45$ Sv)')
...
fig.suptitle('d) Eddy MHT, AMOC on ($F_H = 0.45$ Sv)', fontsize = 13)
...
ax.set_title('c) MHT$_{\mathrm{S}}$ (January), AMOC on ($F_H = 0.45$ Sv)')
...
ax.set_title('d) MHT$_{\mathrm{S,eddy}}$ (January), AMOC on ($F_H = 0.45$ Sv)')
...
ax.set_title('MHT by LHF (January), AMOC on ($F_H = 0.45$ Sv)')
...
ax.set_title('Eddy MHT by LHF (January), AMOC on ($F_H = 0.45$ Sv)')
